...
$success = rejectFriendRequest($userId, $friendId);

if ($success) {
    // Return success response
    echo json_encode(['success' => true, 'message' => 'Demande d\'ami rejetée avec succès']);
} else {
    // Return error response
    echo json_encode(['success' => false, 'message' => 'Erreur lors du rejet de la demande d\'ami']);
}
exit;